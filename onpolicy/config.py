...
def get_config():
    ...
    parser.add_argument("--user_name", type=str, default='3100897298', help="[for wandb usage], to specify user's name for simply collecting training data.")
    ...
    parser.add_argument("--dummy_batch_size", type=int,
                        default=1, help="i dunno")
